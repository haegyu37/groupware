...
////
////        return approvalRepository.findByApproverAndStatus(loginMember, 0);
////    }
////
////    @Override
////    public int approval_Ing(Member loginMember) {
////
////        return approvalRepository.findByApproverAndStatus(loginMember, 1);
////    }
//
//    @Override
//    public int approval_Done(Member loginMember) {
//
//        return approvalRepository.findByApproverAndStatus(loginMember);
//    }
//
//    @Override
